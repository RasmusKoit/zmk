...
#define ZMK_SPLIT_BT_UPDATE_ACTIVITY_STATE_UUID ZMK_BT_SPLIT_UUID(0x00000007)
#define ZMK_SPLIT_BT_UPDATE_BACKLIGHT_BREATHE_UUID ZMK_BT_SPLIT_UUID(0x00000008)
